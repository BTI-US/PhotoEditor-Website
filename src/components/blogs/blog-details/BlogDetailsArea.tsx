...
const content_data: ContentData = {
   ...
   desc_9: (<>The Founder and Creative Director of PhotoEditor, a digital creative studio in USA, has over 15 years of experience as an award-winning Creative Director/Art for clients.</>),
   social_icon: ["fab fa-facebook-f", "fab fa-linkedin-in", "fab fa-twitter", "fab fa-instagram", "fab fa-telegram", "fab fa-google"]
}
               ...
               <div className="col-lg-8">
                  <div className="blog-details-wrap">
                     <div className="blog-details-thumb">
                        {blog?.thumb ? <img src={blog.thumb} alt="image" /> : <img src="/assets/img/blog/blog_details.jpg" alt="image" />}
                     </div>
                     <div className="blog-details-content">
                        <div className="blog-meta">
                           <ul className="list-wrap">
                              <li className="blog-author">
                                 <Link to="/blog-details">{blog?.author_avatar ? <img src={blog?.author_avatar} alt="" /> : <img src="/assets/img/blog/blog_author01.png" alt="" />}
                                    {blog?.author_name ? blog.author_name : "Stacey Moore"}
                                 </Link>
                              </li>
                              <li><i className="far fa-clock"></i>{blog?.date ? blog.date : "2023/03/15"}</li>
                              <li><Link to="/blog-details"><i className="far fa-comment"></i>{blog?.comment ? blog.comment : "07"}</Link></li>
                              <li><i className="far fa-eye"></i>{blog?.views ? blog.views : "1,752Viewers"}</li>
                           </ul>
                        </div>

                        <h2 className="title">{blog?.title ? blog.title : title_1}</h2>
                        {desc_1}
                        {desc_2}
                        {desc_3}
                        {desc_4}
                  ...
                  <div className="blog-avatar-wrap mb-65">
                     <div className="blog-avatar-img">
                        <Link to="#"><img src="/assets/img/blog/avatar.png" alt="img" /></Link>
                     </div>
